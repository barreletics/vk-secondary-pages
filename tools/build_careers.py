...
<div id="careers" class="page active">
  ...
  <section style="background:#EDE8E2;padding:88px 0 72px">
    <div style="max-width:1160px;margin:0 auto;padding:0 40px;display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:center">
      <div>
        <div style="font-size:12px;letter-spacing:0.22em;text-transform:uppercase;color:var(--vk-red);font-weight:600;margin-bottom:16px">Now Hiring · Detroit · LA · Nashville · Remote</div>
        <h1 style="font-family:var(--font-display);font-size:54px;font-weight:500;line-height:1.05;margin:0 0 24px;color:var(--near-black)">Make Your Mark<br>at Vintage King</h1>
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1px;background:rgba(26,26,24,0.12);border-radius:4px;overflow:hidden">
        ...
        <div style="background:#EDE8E2;padding:36px 28px">
          <div style="font-family:var(--font-display);font-size:44px;font-weight:700;color:var(--near-black);line-height:1">3</div>
          <div style="font-size:13px;color:#7A706A;margin-top:6px;letter-spacing:0.04em">Showroom Locations</div>
        </div>
        <div style="background:#EDE8E2;padding:36px 28px">
