...
<div id="warranty" class="page active">
  ...
  <style>
    ...
    .wr-h2 { font-family:'Playfair Display',serif;font-size:36px;font-weight:700;color:#1A1A18;margin:0 0 8px;line-height:1.15;padding-bottom:14px;border-bottom:2px solid #D4860A;display:inline-block }
    ...
    .wr-tier { background:#fff;padding:36px 28px;display:flex;flex-direction:column;transition:box-shadow .3s ease,transform .3s ease;border-top:3px solid #D4860A }
    ...
    .wr-console { background:#fff;padding:24px;transition:box-shadow .3s ease,transform .3s ease;border-top:3px solid #D4860A }
    ...
    .wr-stick-cta { background:#D4860A;color:#fff;padding:10px 22px;font-size:13px;font-weight:600;text-decoration:none;border-radius:2px }
  ...
  <section class="wr-hero">
    <div class="wr-hero-text">
      ...
      <a href="https://vintageking.com/warranty" target="_blank" style="display:inline-block;background:#D4860A;color:#fff;padding:14px 28px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:600;text-decoration:none;border-radius:2px;letter-spacing:0.02em;align-self:flex-start">Learn More</a>
  ...
  <section class="wr-section wr-section-cta">
    <div class="wr-wrap" style="text-align:center">
      ...
      <a href="https://vintageking.com/contact" target="_blank" style="display:inline-block;background:#D4860A;color:#fff;padding:14px 32px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:600;text-decoration:none;border-radius:2px;margin-right:12px">Contact Us</a>
