...
<style>
  ...
  @media print {
    .sg-copy, button { display:none!important }
    .sg-wrap { padding:0 20px }
    .sg-section { page-break-inside:avoid;padding:40px 0 }
...
<section style="background:#EDE8E2;padding:80px 0 64px">
  <div class="sg-wrap">
    ...
    <div style="display:flex;gap:24px;flex-wrap:wrap;align-items:center">
      ...
      <button onclick="window.print()" style="margin-left:8px;background:#1A1A18;color:#fff;border:none;padding:10px 20px;font-family:'DM Sans',sans-serif;font-size:13px;font-weight:600;letter-spacing:0.04em;cursor:pointer;border-radius:2px">Download / Print PDF</button>
    </div>
  </div>
</section>
