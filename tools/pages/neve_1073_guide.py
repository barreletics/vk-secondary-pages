...
<div id="neve-1073-guide" class="page active">
  ...
  <style>
    ...
    .ng-breadcrumb a:hover {{ color:#C0392B }}
    ...
    .ng-sb-body a {{ color:#C0392B;text-decoration:none }}
  ...
  <section style="background:#EDE8E2;padding:72px 48px 0;overflow:hidden">
    <div style="max-width:1280px;margin:0 auto;display:grid;grid-template-columns:1fr 380px;gap:64px;align-items:end">
      <div style="padding-bottom:64px">
        ...
        <h1 style="font-family:'Playfair Display',serif;font-size:clamp(40px,4.5vw,62px);font-weight:700;line-height:1.06;color:#1A1A18;margin-bottom:20px">The Neve 1073<br><em style="font-style:italic;color:rgba(26,26,24,0.55)">History, Legacy &amp; Sound</em></h1>
  ...
  <div class="ng-outer">
    ...
    <aside class="ng-sidebar">
      ...
      <div class="ng-sb-card">
        ...
        <div class="ng-sb-body">
          <p><a href="#">The SSL 4000: History &amp; Legacy</a></p>
