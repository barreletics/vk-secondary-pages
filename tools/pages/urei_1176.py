...
<div id="urei-1176" class="page active">
  ...
  <style>
    ...
    /* hero */
    .u76-hero { background:#EDE8E2;display:grid;grid-template-columns:1fr 1fr;min-height:480px;overflow:hidden }
    ...
    .u76-h2 { font-family:'Playfair Display',serif;font-size:36px;font-weight:700;color:#1A1A18;margin:0 0 8px;line-height:1.15;padding-bottom:14px;border-bottom:2px solid #D4860A;display:inline-block }
    ...
    .u76-spec-table th { text-align:left;padding:12px 16px;background:#1A1A18;color:#FDFCFB;font-weight:600;letter-spacing:0.04em;font-size:11px;text-transform:uppercase;border-bottom:1px solid rgba(255,255,255,0.1) }
    ...
    .u76-dark { background:#1A1A18;padding:56px 64px;display:grid;grid-template-columns:1fr 1fr;gap:56px;align-items:center }
    .u76-dark h3 { font-family:'Playfair Display',serif;font-size:28px;font-weight:700;color:#FDFCFB;margin:0 0 16px }
    .u76-dark p { font-size:15px;color:rgba(253,252,251,0.7);line-height:1.75;margin-bottom:14px }
    .u76-dark p:last-child { margin-bottom:0 }
    .u76-dark-visual { background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);border-radius:3px;padding:32px;text-align:center }
    .u76-dark-label { font-size:10px;letter-spacing:0.14em;text-transform:uppercase;color:rgba(253,252,251,0.35);margin-top:16px }
    ...
    .u76-gc a { font-size:13px;font-weight:600;color:#D4860A;text-decoration:none;border-bottom:1px solid rgba(212,134,10,0.3);margin-top:auto }
    .u76-gc a:hover { border-bottom-color:#D4860A }

    /* reference links */
    .u76-ra { font-family:'DM Sans',sans-serif;font-size:15px;color:rgba(26,26,24,0.65);line-height:1.65;margin-bottom:12px }
    .u76-ra a { color:#D4860A;text-decoration:none;border-bottom:1px solid rgba(212,134,10,0.25) }
    ...
    .u76-stick-cta { background:#D4860A;color:#fff;padding:10px 22px;font-size:13px;font-weight:600;text-decoration:none;border-radius:2px;letter-spacing:0.02em }
  ...
  <section class="u76-hero">
    <div class="u76-hero-text">
      ...
      <a href="https://vintageking.com/urei-universal-audio-1176ln-compressor-limiter" target="_blank" style="display:inline-block;background:#D4860A;color:#fff;padding:14px 28px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:600;text-decoration:none;border-radius:2px;letter-spacing:0.02em;align-self:flex-start">Shop 1176 Models</a>
    ...
    <div class="u76-hero-img">
      <img src="https://vintageking.com/media/catalog/product/u/n/universalaudio_1176ln_1_1.jpg" alt="Universal Audio 1176LN compressor-limiter" loading="lazy">
      <span class="u76-hero-caption" style="color:rgba(26,26,24,0.35)">Universal Audio 1176LN</span>
    </div>
  </section>
  ...
  <!-- ── ALL BUTTONS IN — DARK SECTION ── -->
  <div class="u76-dark">
    <div>
      <h3>"All Buttons In" — The Accident That Became a Standard</h3>
      <p>Pressing all four ratio buttons simultaneously was never intended by the designers. But engineers discovered that it engages a unique compression behavior — the ratio hovers between 12:1 and 20:1, distortion increases dramatically, and the unit produces a distinctive pumping, breathing effect unlike any other compressor.</p>
      <p>This "nuke" or "British Mode" setting became one of the most iconic sounds in recording. Engineers use it on drums for explosive room tone, on vocals for urgent, stressed character, and on room mics for that larger-than-life ambience heard on countless records from Led Zeppelin to Radiohead.</p>
      <p>The 1176's controls are famously reversed: fully clockwise = slowest attack, fully counter-clockwise = fastest (20 microseconds). This catches every first-time user off guard.</p>
    </div>
    <div class="u76-dark-visual">
      <div style="display:flex;justify-content:center;gap:8px;margin-bottom:20px">
        <span class="u76-dark-btn">4:1</span>
        <span class="u76-dark-btn">8:1</span>
        <span class="u76-dark-btn">12:1</span>
        <span class="u76-dark-btn">20:1</span>
      </div>
      <div style="font-family:'Playfair Display',serif;font-size:22px;font-weight:700;color:#D4860A;margin:16px 0 8px">All Four In</div>
      <div style="font-size:13px;color:rgba(253,252,251,0.5);line-height:1.5">Ratio: ~12:1 to 20:1 · Heavy distortion<br>Attack: program-dependent · Character: aggressive pump</div>
      <div class="u76-dark-label">The most famous "mistake" in compressor history</div>
    </div>
  </div>
    ...
    <div class="u76-wrap">
      ...
      <div class="u76-gc-grid">
        <div class="u76-gc">
          ...
          <p>The official reissue. Based on Rev C/D/E, hand-built in Scotts Valley. Class A output, hand-matched FET, original Putnam-designed output transformer. The benchmark.</p>
        ...
        <div class="u76-gc">
          ...
          <div class="u76-gc-price">$2,999</div>
          <p>610 tube preamp paired with the 1176LN compressor in a single 2U chassis. Record-ready signal chain from mic to mix.</p>
        ...
        <div class="u76-gc">
          ...
          <p>Expanded feature set: stepped I/O, sidechain HPF, hard/soft recovery. One of the most respected 1176-style units on the market.</p>
      ...
      <div class="u76-gc-grid" style="margin-top:1px">
        ...
        <div class="u76-gc">
          ...
          <p>Classic FET-style compressor at an entry-level price. All four ratio buttons, all-buttons-in mode. Remarkable value for the 1176 sound.</p>
          <a href="https://vintageking.com/klark-teknik-1176-kt-classic-fet-style-compressor" target="_blank">Shop at Vintage King &rarr;</a>
        </div>
      </div>
    </div>
  </section>
