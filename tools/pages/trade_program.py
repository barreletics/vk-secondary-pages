...
<div id="trade-program" class="page active">
  ...
  <!-- ── HERO 50/50 ── -->
  <section style="display:grid;grid-template-columns:1fr 1fr;min-height:560px;overflow:hidden">
    <div style="background:#EDE8E2;padding:96px 56px 80px 80px;display:flex;flex-direction:column;justify-content:center">
    ...
    <div style="background:#fff;display:flex;align-items:center;justify-content:center;padding:64px 56px">
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1px;background:rgba(26,26,24,0.08);border-radius:4px;overflow:hidden;width:100%;max-width:380px">
  ...
  <div class="vk-stick">
    <div>
      <div class="vk-stick-title">Trade Your Gear</div>
      <div class="vk-stick-sub">Free appraisal · Written offer in 24 hrs · Same-day trade credit</div>
    </div>
    <div style="display:flex;gap:12px;align-items:center">
      <a href="#trade-form" class="vk-stick-cta">Get a Trade Quote →</a>
