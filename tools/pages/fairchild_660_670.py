...
<div id="fairchild-660-670" class="page active">
  ...
  <style>
    ...
    .fc2-gc-img-wrap {{ width:100%;height:180px;overflow:hidden;border-radius:2px;margin-bottom:12px;background:#F7F5F2 }}
    .fc2-gc-img {{ width:100%;height:100%;object-fit:cover;display:block;transition:transform .4s ease }}
    .fc2-guide-card:hover .fc2-gc-img {{ transform:scale(1.06) }}
    ...
    .fc2-alt-img-wrap {{ width:100%;height:160px;overflow:hidden;border-radius:2px;margin-bottom:12px;background:#F7F5F2 }}
    .fc2-alt-img {{ width:100%;height:100%;object-fit:cover;display:block;transition:transform .4s ease }}
    .fc2-alt:hover .fc2-alt-img {{ transform:scale(1.06) }}
  ...
  <section style="background:#EDE8E2;display:grid;grid-template-columns:1fr 1fr;min-height:620px;overflow:hidden">
    ...
    <div style="display:flex;align-items:center;justify-content:center;padding:32px;position:relative;background:#fff">
      <img src="{IMG['hero_670']}" alt="Fairchild Model 670 front panel — dual VU meters and time constant controls" style="width:100%;height:520px;object-fit:contain;display:block">
      <div style="position:absolute;bottom:14px;right:16px;font-size:10px;letter-spacing:0.08em;text-transform:uppercase;color:rgba(26,26,24,0.35);font-family:'DM Sans',sans-serif">Fairchild Model 670 — Original Production Unit</div>
    </div>
  </section>
    ...
    <div class="fc2-wrap">
      <div class="fc2-guide">
        ...
        <div class="fc2-guide-card" style="background:#fff">
          <div class="fc2-gc-img-wrap"><img class="fc2-gc-img" src="https://vintageking.com/media/catalog/product/u/a/uad-fairchild-collection_188183_1.jpg" alt="UAD Fairchild Collection" loading="lazy"></div>
        ...
        <div class="fc2-guide-card" style="background:#fff">
          <div class="fc2-gc-img-wrap"><img class="fc2-gc-img" src="https://vintageking.com/media/catalog/product/h/e/heritage-audio-grandchild-670_209289_1.jpg" alt="Heritage Grandchild 670" loading="lazy"></div>
        ...
        <div class="fc2-guide-card" style="background:#fff">
          <div class="fc2-gc-img-wrap"><img class="fc2-gc-img" src="https://vintageking.com/media/catalog/product/h/e/heritage-audio-670_174007_1.jpg" alt="Heritage Herchild 670" loading="lazy"></div>
        ...
        <div class="fc2-guide-card" style="background:#fff">
          <div class="fc2-gc-img-wrap"><img class="fc2-gc-img" src="https://vintageking.com/media/catalog/product/u/n/undertoneaudio-unfairchild-670m-ii_76735_1.jpg" alt="UnderTone Audio UnFairchild 670M II" loading="lazy"></div>
        ...
        <div class="fc2-guide-card" style="background:#fff">
          <div class="fc2-gc-img-wrap"><img class="fc2-gc-img" src="https://vintageking.com/media/catalog/product/f/a/fairchild-670_191577_1.jpg" alt="Fairchild 670 Reissue" loading="lazy"></div>
        ...
        <div class="fc2-guide-card" style="background:#fff">
          <div class="fc2-gc-img-wrap"><img class="fc2-gc-img" src="https://vintageking.com/media/catalog/product/p/u/puigchild-660_2.jpg" alt="Puigchild 660" loading="lazy"></div>
  ...
  <section style="background:var(--off-white,#F7F5F2);padding:80px 0">
    ...
    <div class="fc2-wide">
      <div class="fc2-alts">
        <div class="fc2-alt">
          <div class="fc2-alt-img-wrap"><img class="fc2-alt-img" src="https://vintageking.com/media/catalog/product/h/e/heritage-audio-grandchild-670_209289_1.jpg" alt="Heritage Grandchild 670" loading="lazy"></div>
        ...
        <div class="fc2-alt">
          <div class="fc2-alt-img-wrap"><img class="fc2-alt-img" src="https://vintageking.com/media/catalog/product/h/e/heritage-audio-660_174008_1.jpg" alt="Heritage Herchild 660" loading="lazy"></div>
        ...
        <div class="fc2-alt">
          <div class="fc2-alt-img-wrap"><img class="fc2-alt-img" src="https://vintageking.com/media/catalog/product/c/h/chandler-ltd-rs660_181479_1.jpg" alt="Chandler RS660" loading="lazy"></div>
        ...
        <div class="fc2-alt">
          <div class="fc2-alt-img-wrap"><img class="fc2-alt-img" src="https://vintageking.com/media/catalog/product/h/e/heritage-audio-670_174007_1.jpg" alt="Heritage Herchild 670" loading="lazy"></div>
        ...
        <div class="fc2-alt">
          <div class="fc2-alt-img-wrap"><img class="fc2-alt-img" src="https://vintageking.com/media/catalog/product/u/n/undertoneaudio-unfairchild-670m-ii_76735_1.jpg" alt="UnFairchild 670M II" loading="lazy"></div>
        ...
        <div class="fc2-alt">
          <div class="fc2-alt-img-wrap"><img class="fc2-alt-img" src="https://vintageking.com/media/catalog/product/f/a/fairchild-670_191577_1.jpg" alt="Fairchild 660 New Production" loading="lazy"></div>
