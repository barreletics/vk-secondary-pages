...
<div id="neumann-u47" class="page active">
  ...
  <section id="which-u47" style="background:#EDE8E2;padding:80px 0">
    <div class="u47-wrap">
      ...
      <p style="font-size:15px;color:rgba(26,26,24,0.55);font-family:'DM Sans',sans-serif;margin:0 0 32px">From $439 capsule-inspired condensers to $9,995 Telefunken reissues — including the U 48 figure-eight reissue. Every U 47-descended option at Vintage King, honestly assessed.</p>
    </div>
    <div class="u47-wide">
      <div class="u47-guide">
        ...
        <div class="u47-gc">
          ...
          <div class="u47-gc-price">~$9,995</div>
          <p>The U 48 variant — same VF14-lineage circuit and M7-style capsule as the U47 reissue, but with cardioid and figure-eight patterns instead of cardioid and omni. The correct choice for engineers who want the U 47 character with the ability to record two singers facing each other on one mic, exactly as George Martin did at Abbey Road.</p>
