...
SLUG  = "neumann-u47"
TITLE = "Neumann U 47 / U 48 — The Undisputed Vocal Microphones | Vintage King Audio"
...
<div id="neumann-u47" class="page active">
  ...
  <style>
    ...
    .u47-gc {{ background:#fff;padding:0 0 24px;position:relative;overflow:hidden;display:flex;flex-direction:column }}
    .u47-gc-img {{ width:100%;height:200px;background:#fff;display:flex;align-items:center;justify-content:center;overflow:hidden;margin-bottom:20px }}
    ...
    .u47-mc span {{ display:block;font-size:10px;letter-spacing:0.18em;text-transform:uppercase;color:#D4860A;margin-bottom:8px }}
  ...
  <section style="background:#fff;padding:80px 0">
    <div class="u47-wrap">
      <div style="font-size:12px;letter-spacing:0.2em;text-transform:uppercase;color:#D4860A;font-family:'DM Sans',sans-serif;margin-bottom:12px">Production History</div>
  ...
  <section style="background:var(--off-white,#F7F5F2);padding:80px 0">
    <div class="u47-wide" style="margin-bottom:40px">
      <div style="font-size:12px;letter-spacing:0.2em;text-transform:uppercase;color:#D4860A;font-family:'DM Sans',sans-serif;margin-bottom:12px">The Rooms That Defined It</div>
  ...
  <section id="which-u47" style="background:#fff;padding:80px 0">
    ...
    <div class="u47-wide">
      <div class="u47-guide">
        ...
        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/t/e/telefunken-elektroakustik-u47_9408_1.jpg" alt="Telefunken U47 large diaphragm tube condenser microphone reissue"></div>
          ...
          <div style="font-size:11px;color:rgba(26,26,24,0.45);font-family:'DM Sans',sans-serif;margin:0 0 12px;padding:0 20px">Capsule: M7 · Tube: VF14K · Transformer: BV8</div>
          <a href="https://vintageking.com/telefunken-usa-u47" target="_blank">Shop Telefunken U47 →</a>
        </div>

        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/p/e/pearlman_tm_1_1.jpg" alt="Vintage King Large Badge U47" loading="lazy"></div>
        ...
        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/w/u/wunder-cm7-gs-m7-2.jpg" alt="Wunder Audio CM7 S" loading="lazy"></div>
          <h4>Wunder Audio CM7 S</h4>
          <div class="u47-gc-price">$7,795</div>
          <p>Swiss-milled brass M7 capsule, NOS Telefunken EF14 tube, and a transformer wound from original-spec vintage Mu-Metal. Smooth across the full range — engineered to handle both lows and highs without fatigue or harshness.</p>
          <div style="font-size:11px;color:rgba(26,26,24,0.45);font-family:'DM Sans',sans-serif;margin:0 0 12px;padding:0 20px">Capsule: M7 (brass) · Tube: NOS EF14 · Transformer: AMI/Tab-Funkerwerk BV8</div>
          <a href="https://vintageking.com/wunder-audio-cm7-s" target="_blank">Shop Wunder CM7 S →</a>
        </div>

        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/f/l/flea_47_with_ef12_2.jpg" alt="FLEA 47" loading="lazy"></div>
          <h4>FLEA 47</h4>
          ...
          <div style="font-size:11px;color:rgba(26,26,24,0.45);font-family:'DM Sans',sans-serif;margin:0 0 12px;padding:0 20px">Capsule: F7 or F47 · Tube: FLEA EF12 or Telefunken EF12 · Transformer: FLEA BV8</div>
          <a href="https://vintageking.com/flea-microphones-flea47" target="_blank">Shop FLEA 47 →</a>
        </div>

        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/p/e/pearlman-church_41871_1.jpg" alt="Heiserman H47tube" loading="lazy"></div>
        ...
        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/p/e/pearlman-tm47_29365_1.jpg" alt="Pearlman TM-47" loading="lazy"></div>
        ...
        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/r/o/roswell-mini-k47_57200_1_3.jpg" alt="Golden Age GA-47 MK II" loading="lazy"></div>
        ...
        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/t/e/telefunken-alchemy-tf47_114220_1.jpg" alt="Telefunken TF47 large diaphragm tube condenser microphone" loading="lazy"></div>
        ...
        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/p/e/peluso_22_47_se_set.jpg" alt="Warm Audio WA-47" loading="lazy"></div>
    ...
    <div class="u47-wide" style="margin-top:2px">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:2px;background:rgba(26,26,24,0.08)">
        ...
        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/f/l/flea-47-next-ii_30815_1.jpg" alt="Neumann U 47 FET Collector's Edition" loading="lazy"></div>
        ...
        <div class="u47-gc">
          <div class="u47-gc-img"><img src="https://vintageking.com/media/catalog/product/n/e/neumann-u48-656-vintage_456897_1.jpg" alt="Telefunken U48" loading="lazy"></div>
  ...
  <section style="background:#fff;padding:80px 0;border-top:1px solid rgba(26,26,24,0.08)">
    <div class="u47-wrap">
      <div style="font-size:12px;letter-spacing:0.2em;text-transform:uppercase;color:#D4860A;font-family:'DM Sans',sans-serif;margin-bottom:12px">See and Hear</div>
