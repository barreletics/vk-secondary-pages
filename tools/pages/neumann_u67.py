...
<div id="neumann-u67" class="page active">
  ...
  <section class="n67-hero">
    ...
    <div class="n67-hero-img">
      <img src="https://images.unsplash.com/photo-1598520106830-8c45c2035460?w=800&q=80" alt="Neumann U67 tube condenser microphone" loading="lazy">
      <span class="n67-hero-caption">Placeholder — replace with VK product photo</span>
    </div>
  </section>
    ...
    <div class="n67-wrap">
      ...
      <div class="n67-gc-grid">
        <div class="n67-gc">
          ...
          <p>Historically accurate. K67 capsule, EF86 tube, interchangeable parts with vintage originals. Three polar patterns, -10 dB pad, bass rolloff. The definitive U67 for modern production.</p>
