...
<div id="neumann-u67" class="page active">
  ...
  <style>
    ...
    .n67-hero-stat-num { font-family:'DM Sans',sans-serif;font-size:22px;font-weight:700;color:#D4860A;line-height:1.1 }
    .n67-hero-stat-label { font-family:'DM Sans',sans-serif;font-size:11px;color:rgba(26,26,24,0.45);margin-top:3px }
    ...
    /* explore strip */
    .n67-explore { background:#EDE8E2;padding:64px 0 }
    .n67-explore-grid { display:grid;grid-template-columns:repeat(3,1fr);gap:20px }
    .n67-explore-card { background:#fff;border-radius:3px;overflow:hidden;text-decoration:none;transition:box-shadow .3s ease,transform .3s ease }
    .n67-explore-card:hover { transform:translateY(-4px);box-shadow:0 12px 32px rgba(26,26,24,0.1) }
    .n67-explore-img { height:180px;background:#F7F5F2;overflow:hidden }
    .n67-explore-img img { width:100%;height:100%;object-fit:cover;display:block;transition:transform .4s ease }
    .n67-explore-card:hover .n67-explore-img img { transform:scale(1.06) }
    .n67-explore-body { padding:20px 24px }
    .n67-explore-tag { font-family:'DM Sans',sans-serif;font-size:10px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:#D4860A;margin-bottom:6px }
    .n67-explore-title { font-family:'Playfair Display',serif;font-size:18px;font-weight:700;color:#1A1A18;margin:0 0 6px }
    .n67-explore-desc { font-family:'DM Sans',sans-serif;font-size:13px;color:rgba(26,26,24,0.55);line-height:1.55;margin:0 }
    ...
    /* buyer guide images */
    .n67-gc-img-wrap { width:100%;height:220px;overflow:hidden;border-radius:2px;margin-bottom:12px;background:#F7F5F2 }
    .n67-gc-img { width:100%;height:100%;object-fit:cover;display:block;transition:transform .4s ease }
    .n67-gc:hover .n67-gc-img { transform:scale(1.06) }
  </style>
  <script>
    (function(){
      var bar=null;
  ...
  <section class="n67-hero">
    <div class="n67-hero-text">
      ...
      <div class="n67-hero-stats">
        ...
        <div><div class="n67-hero-stat-num">60+ yrs</div><div class="n67-hero-stat-label">Of influence</div></div>
      </div>
    </div>
  ...
  <section class="n67-section n67-section-white">
    <div class="n67-wrap">
      ...
      <div class="n67-gc-grid">
        <div class="n67-gc">
          <div class="n67-gc-img-wrap"><img class="n67-gc-img" src="https://vintageking.com/media/catalog/product/n/e/neumann-u67_97358_1.jpg" alt="Neumann U67 Reissue" loading="lazy"></div>
        ...
        <div class="n67-gc">
          <div class="n67-gc-img-wrap"><img class="n67-gc-img" src="https://vintageking.com/media/catalog/product/w/u/wunder-cm-67-2.jpg" alt="Wunder Audio CM67 S" loading="lazy"></div>
        ...
        <div class="n67-gc">
          <div class="n67-gc-img-wrap"><img class="n67-gc-img" src="https://vintageking.com/media/catalog/product/p/e/peluso_p-67_set.jpg" alt="Peluso P-67" loading="lazy"></div>
  ...
  <!-- ── CONTINUE EXPLORING ── -->
  <section class="n67-explore">
    <div class="n67-wrap">
      <div class="n67-eyebrow">Continue Exploring</div>
      ...
      <div class="n67-explore-grid">
        <a href="urei-1176.html" class="n67-explore-card">
          <div class="n67-explore-img"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/UREI_1176LN_%28Silver%29_x6.jpg/600px-UREI_1176LN_%28Silver%29_x6.jpg" alt="UREI 1176" loading="lazy"></div>
          <div class="n67-explore-body">
            <div class="n67-explore-tag">Hall of Fame</div>
            <div class="n67-explore-title">The Universal Audio 1176</div>
            <p class="n67-explore-desc">The most-used compressor in recording history. Solid-state FET design since 1967.</p>
          </div>
        </a>
        <a href="warranty.html" class="n67-explore-card">
          <div class="n67-explore-img"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Outboard_racks_1-2%2C_PatchWerk_Recording_Studios%2C_2007.jpg/960px-Outboard_racks_1-2%2C_PatchWerk_Recording_Studios%2C_2007.jpg" alt="Studio gear" loading="lazy"></div>
          <div class="n67-explore-body">
            <div class="n67-explore-tag">Buyer Protection</div>
            <div class="n67-explore-title">VK Warranty</div>
            <p class="n67-explore-desc">+1 free year on every purchase. No registration. Optional ADH coverage.</p>
          </div>
        </a>
        <a href="section-179.html" class="n67-explore-card">
          <div class="n67-explore-img"><img src="https://upload.wikimedia.org/wikipedia/commons/e/e5/Rack_Outboard_Location_Recording.jpg" alt="Outboard gear rack" loading="lazy"></div>
          <div class="n67-explore-body">
            <div class="n67-explore-tag">Tax Savings</div>
            <div class="n67-explore-title">Section 179 Deduction</div>
            <p class="n67-explore-desc">Write off the full cost of qualifying equipment the year you buy it.</p>
          </div>
        </a>
      </div>
    </div>
