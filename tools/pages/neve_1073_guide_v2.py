...
<div id="neve-1073-guide-v2" class="page active">
  ...
  <div class="nv2-bread">
    ...
    <a href="#">Preamps &amp; EQs</a><span>›</span>
    The Neve 1073 — Editorial
  </div>

  <!-- ── HERO — LIGHT ── -->
  <section style="background:#EDE8E2;padding:72px 0 0;overflow:hidden">
    <div class="nv2-wide" style="display:grid;grid-template-columns:1fr 340px;gap:72px;align-items:end">
      ...
      <div style="align-self:end;display:flex;align-items:flex-end;justify-content:center">
        <img src="{IMG['vertical_80s']}" alt="AMS Neve 1073 80-series module vertical" style="max-height:380px;width:auto;display:block;filter:drop-shadow(0 10px 36px rgba(26,26,24,0.16))">
      </div>
    </div>
  </section>
  ...
  <section style="background:#EDE8E2;padding:72px 48px">
    <div style="max-width:680px;margin:0 auto;text-align:center">
      ...
      <h2 style="font-family:'Playfair Display',serif;font-size:36px;font-weight:700;color:#1A1A18;margin-bottom:16px">We've Serviced, Sold &amp; Restored More Neve Than Anyone</h2>
