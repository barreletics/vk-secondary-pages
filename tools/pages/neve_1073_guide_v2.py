...
<div id="neve-1073-guide-v2" class="page active">
  ...
  <style>
    ...
    .nv2-studios {{ max-width:1280px;margin:52px auto;padding:0 48px;display:grid;grid-template-columns:1fr 1fr;gap:16px }}
    .nv2-sc {{ background:#1A1A18;overflow:hidden }}
    .nv2-sc-sm {{ grid-column:auto }}
    .nv2-sc-lg {{ grid-column:1 / span 2 }}
    .nv2-sc-lg .nv2-sc-img {{ height:420px }}
    ...
    .nv2-sc-loc {{ position:absolute;bottom:12px;left:0;right:0;text-align:center;font-size:11px;color:#D4860A;letter-spacing:0.08em;font-weight:600 }}
    ...
    .nv2-tl-yr {{ font-family:'Playfair Display',serif;font-size:20px;font-weight:700;color:#C0392B;padding-top:3px }}
