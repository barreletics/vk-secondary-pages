...
<div id="la-2a" class="page active">
  ...
  <style>
    ...
    .la2-tl-body .la2-tl-tag {{ display:inline-block;font-size:10px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;padding:2px 8px;margin-bottom:6px }}
    ...
    .la2-ra {{ font-size:13px;color:rgba(26,26,24,0.48);margin-top:2px }}
  ...
  <section style="background:#EDE8E2;padding:80px 48px 56px;overflow:visible">
    <div style="max-width:1280px;margin:0 auto;display:grid;grid-template-columns:1fr 460px;gap:72px;align-items:end">
      ...
      <div>
        <img src="{IMG['hero']}" alt="Teletronix LA-2A leveling amplifier front panel" style="width:100%;max-height:360px;object-fit:cover;object-position:center 30%;display:block">
        <div style="font-size:11px;letter-spacing:0.08em;text-transform:uppercase;color:rgba(26,26,24,0.4);margin-top:10px;font-family:'DM Sans',sans-serif">Teletronix LA-2A — PatchWerk Recording Studios, Atlanta</div>
      </div>
    </div>
  </section>
      ...
      <div class="la2-timeline">
        <div class="la2-tl-item">
          ...
          <div class="la2-tl-body">
            <div class="la2-tl-tag" style="background:#D4860A">Rev 1 — "Grayface"</div>
        ...
        <div class="la2-tl-item">
          ...
          <div class="la2-tl-body">
            <div class="la2-tl-tag" style="background:#6B6B68">Rev 2A — "Silverface" Babcock</div>
        ...
        <div class="la2-tl-item">
          ...
          <div class="la2-tl-body">
            <div class="la2-tl-tag" style="background:#6B6B68">Rev 2B — Licensed Version</div>
        ...
        <div class="la2-tl-item">
          ...
          <div class="la2-tl-body">
            <div class="la2-tl-tag" style="background:#6B6B68">Rev 2C — UREI</div>
        ...
        <div class="la2-tl-item">
          ...
          <div class="la2-tl-body">
            <div class="la2-tl-tag" style="background:#2C2C2A">Reissue 1 — UREI Limited Edition</div>
        ...
        <div class="la2-tl-item">
          ...
          <div class="la2-tl-body">
            <div class="la2-tl-tag" style="background:#2C2C2A">Reissue 2 — Harman/JBL Limited Edition</div>
        ...
        <div class="la2-tl-item">
          ...
          <div class="la2-tl-body">
            <div class="la2-tl-tag" style="background:#C0392B">Current — Universal Audio</div>
    ...
    <div class="la2-wide">
      <div class="la2-guide">
        ...
        <div class="la2-gc" style="background:#fff">
          <div class="la2-gc-tag" style="background:#D4860A">In the Box</div>
          <h4>Waves CLA-2A</h4>
        ...
        <div class="la2-gc" style="background:#fff">
          <div class="la2-gc-tag" style="background:#1A1A18">Pro Studio</div>
        ...
        <div class="la2-gc" style="background:#fff">
          <div class="la2-gc-tag" style="background:#C0392B">Reference</div>
