...
<div id="la-2a" class="page active">
  ...
  <section style="background:#EDE8E2;display:grid;grid-template-columns:1fr 1fr;min-height:560px;overflow:hidden">
    ...
    <div style="position:relative">
      <img src="{IMG['hero']}" alt="Teletronix LA-2A leveling amplifier front panel" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center 30%;display:block">
