...
<div id="la-2a" class="page active">
  ...
  <style>
    ...
    .la2-gc a {{ font-size:13px;font-weight:600;color:#D4860A;text-decoration:none;border-bottom:1px solid rgba(212,134,10,0.3) }}
    ...
    .la2-mc span {{ display:block;font-size:10px;letter-spacing:0.18em;text-transform:uppercase;color:#D4860A;margin-bottom:8px }}
    ...
    .la2-mc a {{ font-size:13px;font-weight:600;color:#D4860A;text-decoration:none }}

    /* Sticky bar */
    .la2-stick {{ position:fixed;bottom:0;left:0;right:0;background:#1A1A18;z-index:500;display:flex;align-items:center;justify-content:space-between;padding:14px 40px;border-top:2px solid #D4860A }}
    ...
    .la2-stick-cta {{ background:#D4860A;color:#fff;padding:12px 28px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:600;text-decoration:none;letter-spacing:0.04em }}
  ...
  <section style="background:#EDE8E2;display:grid;grid-template-columns:1fr 1fr;min-height:620px;overflow:hidden">
    <div style="padding:80px 56px 80px 80px;display:flex;flex-direction:column;justify-content:center">
      ...
      <div style="display:flex;gap:12px;flex-wrap:wrap">
        <a href="https://vintageking.com/teletronix-la-2a-optical-compressor-limiter" target="_blank" style="background:#D4860A;color:#fff;padding:14px 32px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:600;text-decoration:none;letter-spacing:0.04em">Shop All LA-2A</a>
  ...
  <section style="background:#EDE8E2;padding:80px 48px">
    <div style="max-width:680px;margin:0 auto;text-align:center">
      ...
      <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap">
        <a href="https://vintageking.com/teletronix-la-2a-optical-compressor-limiter" target="_blank" style="background:#D4860A;color:#fff;padding:16px 36px;font-family:'DM Sans',sans-serif;font-size:15px;font-weight:600;text-decoration:none;letter-spacing:0.04em">Shop All LA-2A</a>
