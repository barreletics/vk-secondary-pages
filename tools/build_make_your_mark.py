      ...
      <div class="mym-grid" style="grid-template-columns:repeat(3,1fr);gap:24px">
        ...
        <a href="#" class="mym-card">
          <div class="mym-card-thumb" style="background:linear-gradient(135deg,#100E08,#1C1A10);position:relative">
            ...
            <div style="position:absolute;bottom:12px;left:12px;font-size:12px;font-weight:600;letter-spacing:0.10em;text-transform:uppercase;color:rgba(212,134,10,0.70)">Collin Dupuis</div>
          ...
          <div class="mym-card-title">"Recording Dan Auerbach — and learning to get out of the way"</div>
